...
class pdcblock1(nn.Module):
    def __init__(self, inchannel, outchannel):
        ...
        self.basic=nn.Sequential(
                Conv_PDC(inchannel, outchannel, kernel_size=3, padding=1, stride=2),
...
class DCONV(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride = 1):
        ...
        self.down = Conv_PDC(in_channels, out_channels, kernel_size = 3,
...
class Net(nn.Module):
  ...
  def forward(self, input):
    ...
    spp = spatial_pyramid_pool(output, output.size(0), [int(output.size(2)),int(output.size(3))], [4,2,1])
...
def main(args):
    ...
    COVER_DIR = '/data/ALASKA_v2_TIFF_512_COLOR_40000_cover'
    STEGO_DIR = '/data/ALASKA_v2_TIFF_512_COLOR_40000_stego'

    TEST_COVER = '/data/Cover_512x512'
    TEST_STEGO = '/data/Stego_512x512_CMDCHILL'

    TRAIN_INDEX_PATH = 'index_list/train_index_24000.npy'
    VALID_INDEX_PATH = 'index_list/valid_index_4000.npy'
    TEST_INDEX_PATH = 'index_list/var_test_index_3000.npy'
